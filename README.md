...
예를 들어, This is a normal paragraph:
```
This is a code block.
```
end code block.
...
```
syntax: [Title](link)
타이틀이 링크의 이름// 링크는 실질적으로 주소가 되는 사이트입니다.
```
...
## 7. 강조
```
*single asterisks* // 약한강조
_single underscores_ 
**double asterisks** // 강한강조
...
```
![Alt text](http://dh.aks.ac.kr/Edu/wiki/images/5/50/%EC%A7%B1%EA%B5%AC.jpeg)
